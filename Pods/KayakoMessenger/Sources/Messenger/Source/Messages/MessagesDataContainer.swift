...
class MessagesDataContainer {
	...
	func updateMessagesData() {
        ...
        let tempCount = botMessages.count + messageItemIDs.count + pendingMessages.count + (statusIndex == nil ? 0 : 1)
		let count = tempCount + typingIndicators.count + (botFeedback == nil ? 0 : 1)
